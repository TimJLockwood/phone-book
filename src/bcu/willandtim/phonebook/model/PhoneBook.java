...
public class PhoneBook {
	...
	/*
	 * Adds an entry to the phone book, given the name and phone number. An
	 * AlreadyPresentException is thrown if that name is already present.
	 */
	...
	/*
	 * Gets an entry from the phone book, given the name. A NotPresentException is
	 * thrown if that name is not present.
	 */
	...
	/*
	 * Updates an entry, given the name and a new phone number. A
	 * NotPresentException is thrown if that name is not present.
	 */
	...
	/*
	 * Removes an entry from the phone book, given the name. A NotPresentException
	 * is thrown if that name is not present.
	 */
